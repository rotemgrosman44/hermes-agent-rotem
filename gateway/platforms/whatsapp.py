...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    async def send_voice(
        ...
        **kwargs,
        ...
        """Send audio natively via bridge.

        The bridge already distinguishes voice-note style delivery from regular
        audio based on the file extension:
        - `.ogg` / `.opus` -> sent as PTT/voice note
        - `.mp3` / `.wav` / `.m4a` -> sent as regular audio
        """
