(function () {
  ...
  function FacebookLogo() {
    return React.createElement("div", {
      className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-sm border text-3xl font-bold",
      style: {
  ...
  function BrandLogo(props) {
    ...
    if (props.brand === "facebook") return React.createElement(FacebookLogo);
  ...
  function OfficeCard(props) {
    ...
    return React.createElement(Card, { style: panelStyle },
      React.createElement(CardHeader, null,
        React.createElement("div", { className: "flex items-start gap-4" },
          React.createElement("div", {
            className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-sm border font-mono-ui text-xs font-bold uppercase tracking-[0.18em]",
            style: {
              borderColor: "var(--color-border)",
          ...
          React.createElement("div", { className: "min-w-0 flex-1 text-right", dir: "rtl" },
            React.createElement("div", { className: "flex flex-wrap justify-end gap-2" },
              okBadge(Boolean(item.office_running), "Office פעיל", "Office כבוי"),
              okBadge(Boolean(item.adapter_running), "adapter פעיל", "adapter כבוי"),
            ),
            React.createElement(CardTitle, { className: "mt-3 text-lg normal-case tracking-normal" }, item.label_he),
            React.createElement("div", { className: "mt-2 text-sm text-muted-foreground" }, item.note_he),
          ),
      ...
      React.createElement(CardContent, { className: "flex flex-col gap-3" },
        React.createElement("div", { className: "grid gap-3 md:grid-cols-3" },
          field("כתובת Office", item.office_url),
          field("Gateway", item.adapter_url),
          field("מצב", ready ? "ready" : "needs start"),
        ),
        React.createElement("a", { href: item.office_url, target: "_blank", rel: "noreferrer" },
          React.createElement(Button, { type: "button", variant: ready ? "default" : "outline" }, ready ? "Open Kanban / Office" : "Open Office URL"),
        ),
        React.createElement("div", { className: "grid gap-3 lg:grid-cols-2" }, (item.commands || []).map(function (command) {
          return React.createElement(CopyCommand, { key: command.value, label: command.label_he, value: command.value });
        })),
  ...
  function MadHatterPage() {
    ...
    const summary = useMemo(function () {
      ...
      const facebookOk = data && data.facebook && data.facebook.status && data.facebook.status.platform_state === "connected" && data.facebook.status.pid_running;
      ...
      React.createElement("section", { className: "p-5", style: panelStyle },
        React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-4" },
          React.createElement("div", { className: "max-w-4xl text-right", dir: "rtl" },
            React.createElement("div", { className: "text-xs uppercase tracking-[0.18em] text-muted-foreground", dir: "ltr" }, "Hermes / Agents"),
            React.createElement("h1", { className: "mt-2 text-2xl font-semibold normal-case tracking-normal" }, data ? data.title_he : "לוח הסוכנים של Hermes"),
          ...
          React.createElement("div", { className: "flex flex-wrap gap-2" },
            ...
            okBadge(summary.facebookOk, "Facebook מחובר", "Facebook לבדיקה"),
            okBadge(summary.cronOk, "4 cron תקינים", "cron לבדיקה"),
            okBadge(summary.officeOk, "Kanban פעיל", "Kanban כבוי"),
          ),
        ),
