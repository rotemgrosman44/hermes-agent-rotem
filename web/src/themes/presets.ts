...
export const hermesGreenDarkTheme: DashboardTheme = {
  ...
  palette: {
    background: { hex: "#124b43", alpha: 1 },
    midground: { hex: "#e6fff2", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0 },
    warmGlow: "rgba(45, 212, 191, 0.26)",
    noiseOpacity: 0.65,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
  ...
  colorOverrides: {
    ...
    popover: "#185e54",
    popoverForeground: "#f6fffb",
    primary: "#2dd4bf",
    primaryForeground: "#05211f",
    secondary: "#1f6f62",
    secondaryForeground: "#effff8",
    muted: "#1a6157",
    mutedForeground: "#c8eee0",
    accent: "#23786a",
    accentForeground: "#f6fffb",
    success: "#22c55e",
    warning: "#facc15",
    destructive: "#ef4444",
...
export const hermesLightTheme: DashboardTheme = {
  ...
  palette: {
    background: { hex: "#e8f5ee", alpha: 1 },
    midground: { hex: "#075e45", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0 },
    warmGlow: "rgba(16, 185, 129, 0.22)",
    noiseOpacity: 0.45,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
